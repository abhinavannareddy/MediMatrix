...
Write-Host "   $user/medimatrx-auth:$version"
Write-Host "   $user/medimatrx-verification:$version"
Write-Host "   $user/medimatrx-validation:$version"
Write-Host "   $user/medimatrx-authorization:$version"
...
$services = @("ingest", "price", "optimizer", "assistant", "forecast", "auth", "verification", "validation", "authorization", "gateway")
